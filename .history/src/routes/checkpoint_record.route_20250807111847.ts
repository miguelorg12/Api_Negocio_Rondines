 ...
 *         description: Error en la validación de datos
 */
router.get("/branch/:branchId", authenticateToken, getCheckpointRecordsByBranchValidator, checkpointRecordController.findAllByBranchId.bind(checkpointRecordController));
