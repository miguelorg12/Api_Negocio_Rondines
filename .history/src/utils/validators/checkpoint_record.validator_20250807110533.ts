...
export const getCheckpointRecordsByBranchValidator = [
  param("branchId")
    .isInt({ min: 1 })
    .withMessage("El ID de la sucursal es obligatorio y debe ser un número entero positivo"),
  
  validateRequest,
];

export const getCheckpointRecordsByPatrolAssignmentValidator = [
  param("patrolAssignmentId")
    .isInt({ min: 1 })
    .withMessage("El ID de la asignación de patrulla es obligatorio y debe ser un número entero positivo"),
