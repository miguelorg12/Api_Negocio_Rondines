        ...
        GuardCreateRequest: {
         ...
         CheckpointRecordResponse: {
           ...
           properties: {
             ...
             real_check: { type: "string", format: "date-time", nullable: true },
             patrol_assignment: {
               type: "object",
               properties: {
                 id: { type: "integer" },
         ...
         CheckpointRecordCreateRequest: {
           type: "object",
           required: ["patrol_assignment_id", "checkpoint_id", "check_time"],
           properties: {
             patrol_assignment_id: { type: "integer" },
         ...
         CheckpointRecordUpdateRequest: {
           ...
           properties: {
             ...
             real_check: { type: "string", format: "date-time" },
           },
         },
       },
     },
